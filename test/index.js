...
describe('wt-tracker.', () => {
  ...
  it('should override defaults with event data', (done) => {
    const events = [{ pageName: 'Account', direction: 'up' }, { objectName: 'Box', objectType: 'Button' }];

    wt('set', { meta: 'data', customerID: 5, pageName: 'Home' });
